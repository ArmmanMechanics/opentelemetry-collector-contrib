...
require (
	...
	github.com/DataDog/datadog-agent/comp/otelcol/logsagentpipeline/logsagentpipelineimpl v0.62.0
	...
	github.com/DataDog/datadog-agent/pkg/util/hostname/validate v0.62.0
