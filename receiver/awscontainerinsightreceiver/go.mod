...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/containerinsight v0.113.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/k8s v0.113.0
